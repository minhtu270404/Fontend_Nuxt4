            ...
            <div class="">
              <div class="font-lg mb-30">
                <p>
                  ...
                  Quisque ornare pellentesque sollicitudin. Suspendisse potenti.
                  Fusce ex risus, iaculis sit amet sapien nec, finibus malesuada
                  mi. Proin at turpis eget sapien pulvinar luctus. Vestibulum
                  bibendum pharetra lorem eu aliquam. In feugiat placerat risus,
                  sed rutrum neque mattis sit amet. Nullam vestibulum ante ac
                  quam tempor, id venenatis velit eleifend. Duis id iaculis
            ...
            <div class="">
              <div class="content-single">
                ...
                <p>
                  ...
                  parturient montes, nascetur ridiculus mus. Integer vitae ante
              ...
              <div class="single-apply-jobs mt-20">
                <div class="row">
                  <div class="col-lg-7">
                    ...
                    ><a class="btn btn-border-3 mr-10 hover-up" href="#"
                      ># Beauty</a
                    ><a class="btn btn-border-3 hover-up" href="#"
                      ># Travel tips</a
                    >
                  </div>
                  <div class="col-md-5 text-lg-end social-share">
                    ...
                    <a class="mr-20 d-inline-block d-middle hover-up" href="#"
                      ><img
                        alt="joblist"
                        src="/assets/imgs/page/blog/fb.svg" /></a
                    ><a class="mr-20 d-inline-block d-middle hover-up" href="#"
                      ><img
                        alt="joblist"
                        src="/assets/imgs/page/blog/tw.svg" /></a
                    ><a class="mr-0 d-inline-block d-middle hover-up" href="#"
                      ><img alt="joblist" src="/assets/imgs/page/blog/pi.svg"
                    /></a>
                  </div>
                </div>
              </div>
                  ...
                  <div class="author-bio mt-40 bg-white">
                    ...
                    <div class="author-des">
                      <p class="font-md color-text-paragraph">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Sed ultricies interdum massa nec fermentum. Phasellus
                        interdum dignissim rhoncus. Nam vitae semper magna.
                        Donec massa enim
                      </p>
                    </div>
                  </div>
                  ...
                  <form action="#">
                    ...
                    <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-7 mb-30">
                        <label class="box-agree">
                          <input class="chkbox-aggree" type="checkbox" /><span
                            class="font-sm color-text-paragraph"
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-5 text-end">
                        <button class="btn btn-default font-bold">
                          Post comment
                        </button>
                      </div>
                    </div>
...
<script setup>
import JobTips from "~/components/Blog/JobTips.vue";
