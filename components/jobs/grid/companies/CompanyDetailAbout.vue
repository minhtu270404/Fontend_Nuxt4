            ...
            <div class="box-list-jobs display-list">
              <div class="col-xl-12 col-12">
                <div class="card-grid-2 hover-up">
                  ...
                  <div class="card-block-info">
                    <h4>
                      <a href="">Senior System Engineer</a>
                    </h4>
                    <div class="mt-5">
                      <span class="card-briefcase">Part time</span
                      ><span class="card-time"
                        ><span>5</span><span> mins ago</span></span
                      >
                    </div>
                ...
                <div class="card-grid-2 hover-up">
                  ...
                  <div class="card-block-info">
                    ...
                    <div class="mt-5">
                      ...
                      ><span class="card-time"
                        ><span>6</span><span> mins ago</span></span
                      >
                    </div>
                    <p class="font-sm color-text-paragraph mt-10">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              ...
              <div class="col-xl-12 col-12">
                <div class="card-grid-2 hover-up">
                  ...
                  <div class="card-block-info">
                    <h4>
                      <a href="">Lead Quality Control QA</a>
                    </h4>
                    <div class="mt-5">
                      <span class="card-briefcase">Full time</span
                      ><span class="card-time"
        ...
        >
          <div class="sidebar-border">
            <div class="sidebar-heading">
              <div class="avatar-sidebar">
                <div class="sidebar-info pl-0">
                  <span class="sidebar-company">AliThemes</span
              ...
              <ul>
                <li>
                  ...
                  <div class="sidebar-text-info">
                    ...
                    ><strong class="small-heading">Accounting / Finance</strong>
                  </div>
                </li>
                <li>
                  <div class="sidebar-icon-item">
                  ...
                  <div class="sidebar-text-info">
                    ...
                    ><strong class="small-heading"
                      >Chicago, US Remote Friendly</strong
                    >
                  </div>
                </li>
                <li>
            ...
            <div class="sidebar-list-job">
              ...
              <div class="mt-30">
                <a class="btn btn-send-message" href="">Send Message</a>
              </div>
            </div>
          </div>
        </div>
