            ...
            <div class="tab-content">
              ...
              >
                ...
                <p>
                  ...
                  and I&rsquo;m very passionate and dedicated to my work. With
                  20 years experience as a professional a graphic designer, I
                ...
                <div class="row mb-40">
                  <div class="col-lg-6 col-md-6 col-sm-12 mb-30">
                    ...
                    <div class="box-progress-bar mt-20">
                      <p class="font-xs color-text-paragraph-2 mb-10">
                        HTML &amp; CSS
                      </p>
                      <div class="progress">
                        <div
                          class="progress-bar bg-paragraph-2"
                          role="progressbar"
                          style="width: 78%"
                          aria-valuenow="25"
                          aria-valuemin="0"
                      ...
                      <p class="font-xs color-text-paragraph-2 mb-10 mt-30">
                        Javascript
                      </p>
                      <div class="progress">
                        <div
                          class="progress-bar bg-brand-2"
                          role="progressbar"
                          style="width: 88%"
                          aria-valuenow="50"
                          aria-valuemin="0"
              ...
              >
                ...
                <p></p>
                Hello there! My name is Alan Walker. I am a graphic designer,
                and I&rsquo;m very passionate and dedicated to my work. With 20
          ...
          <div class="box-related-job content-page cadidate_details_list">
            ...
            <div class="box-list-jobs display-list">
              <div class="col-xl-12 col-12">
                <div
                  class="card-grid-2 hover-up wow animate__animated animate__fadeIn"
                >
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="card-grid-2-image-left">
                        ...
                        <div class="right-info">
                          <a class="name-job" href="">Quora JSC</a
                  ...
                  <div class="card-block-info">
                    ...
                    <div class="mt-5">
                      ...
                      ><span class="card-time"
                        ><span>5</span><span> days ago</span></span
                      >
                    </div>
                      ...
                      <div class="row">
                        <div class="col-lg-7 col-7">
                          <span class="card-text-price"
                            >Status:<span class="text-success">Done</span></span
                          >
                        </div>
                        <div class="col-lg-5 col-5 text-end">
                          <a class="btn btn-apply-now" href="job-details.html"
                            >View Details</a
                          >
                        </div>
                      </div>
                ...
                >
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="card-grid-2-image-left">
                        ...
                        <div class="right-info">
                          <a class="name-job" href="">Nintendo</a
                          ><span class="location-small">New York, US</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card-block-info">
                    ...
                    <div class="mt-5">
                      ...
                      ><span class="card-time"
                        ><span>6</span><span> days ago</span></span
                      >
                    </div>
                    <p class="font-sm color-text-paragraph mt-10">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="card-grid-2-image-left">
                        ...
                        <div class="right-info">
                          <a class="name-job" href="">Periscope</a
                          ><span class="location-small">New York, US</span>
                        </div>
                      </div>
                    </div>
        ...
        >
          <div class="sidebar-border">
              ...
              <ul>
                <li>
                  ...
                  <div class="sidebar-text-info">
                    ...
                    ><strong class="small-heading">12 years</strong>
                  </div>
                </li>
                <li>
                  <div class="sidebar-icon-item">
                  ...
                  <div class="sidebar-text-info">
                    <span class="text-description">Expected Salary</span
                    ><strong class="small-heading">$26k - $30k</strong>
                  </div>
                </li>
                <li>
                  <div class="sidebar-icon-item">
                  ...
                  <div class="sidebar-text-info">
                    <span class="text-description">Language</span
                    ><strong class="small-heading">English, German</strong>
                  </div>
                </li>
                <li>
                  <div class="sidebar-icon-item">
                  ...
                  <div class="sidebar-text-info">
                    <span class="text-description">Education Level</span
                    ><strong class="small-heading">Master Degree</strong>
                  </div>
                </li>
              </ul>
            </div>
            <div class="sidebar-list-job">
              ...
              <div class="mt-30">
                <a class="btn btn-send-message" href="page-contact.html"
                  >Send Message</a
                >
              </div>
            </div>
